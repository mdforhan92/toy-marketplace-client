...
const UpdateToy = () => {
  useTitle('PopToy | AddToy')
    ...
    const { sellerName, name, subCategory, price, availableQuantity, email, _id, rating ,description, imgUrl} = updateToy;

    const handleToUpdateToy = event =>{
    ...
    return (
        <div>
            ...
            <div>
            <h1 className="text-2xl font-bold mb-4 mt-4 text-center ">Update Toy</h1>
            <div className="max-w-md mx-auto">
      <form onSubmit={handleToUpdateToy} className="bg-white p-6 rounded-lg shadow-md">
